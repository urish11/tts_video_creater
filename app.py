...
#                 """
                ...
                if script_json:
                    ...
                    for idx, element in enumerate(script_json):
                        ...
                        gemini_prompt = chatGPT(f"""write short prompt for\ngenerate 9:16 image promoting '{visual}'  {random.choice(['use photos'])}. add a CTA button with 'Learn More Here >>' in appropriate language\nshould be low quality and very enticing and alerting\nstart with ' image aspect ratio of of '\n\n example output:\n\ 9:16 image of a concerned middle-aged woman looking at her tongue in the mirror under harsh bathroom lighting, with a cluttered counter and slightly blurry focus — big bold red text says “Early Warning Signs?” and a janky yellow button below reads “Learn More Here >>” — the image looks like it was taken on an old phone, with off angle, bad lighting, and a sense of urgency and confusion to provoke clicks.""")
