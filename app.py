        ...
        for _, row in df.iterrows():
            ...
            for i in range(count):
                ...
                prompt = f"""Write a JSON-formatted script for a 10–15 second video ad promoting: "{topic}".
                                ...
                                Requirements:
                                • Start with a *concrete relatable moment or involving a real-life scenario. Not 1st person !!
                                ...
                                • End with a strong convinsing click driving CTA like: “Click to explore options” or “Tap to see how it works.”
